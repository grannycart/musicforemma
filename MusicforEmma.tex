% MusicforEmma.tex
% Last modified: Thu Jul 29, 2021  09:23PM
...
% good for presentation-quality pdfs
...
% \setlength{\parskip}{0.6pt} 
 \title{Music for Emma}
 \date{November 2, 2014} % Original date I emailed this list to Emma
 \author{--- --- --- }

\begin{document} 
\maketitle
% \large % good for presentation-quality pdfs
% \itshape % Originally used this (and the matching \upshape below) to define an italics block. 
...
% And you can download the playlist \href{https://u.pcloud.link/publink/show?code=XZEpgg7ZmPbndzuwJGbRqRIyygg5uJ9d1mrk}{here}.\\
% \upshape
...
% And It's better than \emph{Suzanne} or \emph{Hallelujah}, even if more people know those songs.
